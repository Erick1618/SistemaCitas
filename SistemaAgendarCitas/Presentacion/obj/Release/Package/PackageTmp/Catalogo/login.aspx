            ...
            <div class="card">
                <div class="card-body text-center">  
                    <form runat="server">
                        ...
                        <br />
                        <asp:TextBox ID="Tbemail" runat="server" CssClass = "connect" Width="293px"  ></asp:TextBox>     
                        <br />
                        ...
                        <br />
                        <asp:TextBox ID="TbPass" runat="server" TextMode="Password" Width="284px"></asp:TextBox> 
                        <br />
                        ...
                        <br />
                        <asp:LinkButton ID="BtnIniciarSesion" runat="server" class="btn btn-primary" type="submit"  OnClick="BtnIniciarSesion_Click" >Iniciar sesión</asp:LinkButton>
                        <br />                      
                        <br />
                        <asp:LinkButton ID="BtnRegistrar" runat="server" class="btn btn-primary" type="submit"  OnClick="BtnRegistrate_Click" >Registrate</asp:LinkButton>
                      </form>
                </div>
            </div>
       </div>
